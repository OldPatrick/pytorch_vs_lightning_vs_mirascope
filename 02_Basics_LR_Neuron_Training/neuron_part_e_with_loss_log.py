...
# the learning rate gets quite stall or linear when learning rate is too small like 0.00001
# the plot shows we could stop much earlier like in iteration 2500
# so we could limit it manually, but here would be a good time to include early stopping
# it fluctuates more in the plot with more neurons and layers, here we have only one neuron
my_X = torch.tensor([
    [5, 10000], 
    [2, 10000],
    [2, 30000] 
